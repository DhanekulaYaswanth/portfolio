...
function Contact(props){
    ...
    const sendHiiMail = (e) =>{
        ...
        Axios
            .post('https://yaswanthserver.vercel.app/sendhiimail',{'Email':mail,'message':'Hii'})
            .then(response=>{
    ...
    const sendContactMail = (e) => {
      ...
      Axios.post('https://yaswanthserver.vercel.app/sendcontactform', { 'Email': emailid, 'subject': subject, 'name': name, 'message': message })
        .then(response => {
          setResult(response.data.success);
          setissent(true);
          var copy = [...content];
