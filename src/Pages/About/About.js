    ...
    return(
        <div className="AboutContainer">
            ...
            <header style={{width:"auto", marginLeft:"5%"}} className="Abouttext">
                ...
                <div>
                  <Link to="https://drive.google.com/file/d/1EGtBBsySVnm32aKX-AZoYi9PliEax7Em/view?usp=share_link" target="_blank"><button className="resumebutton" style={{borderColor:theme==='dark'?'black':''}}><span style={{color:theme==='dark'?'black':''}}>View Resume</span></button></Link>
                </div>
            </header>
        </div>
    )
