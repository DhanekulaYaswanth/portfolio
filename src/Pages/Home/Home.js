    ...
    return(
        <div className="homecontainer">
            ...
            <header style={{width:"auto", marginLeft:"5%"}} className="bg-text">
                    <h1 className="intro">Hi, I'm <span className={theme==='dark'?'name':"name name_dark"}><Link to="https://www.linkedin.com/in/dhanekula-yaswanth/" target="_blank">Dhanekula Yaswanth</Link></span></h1>
